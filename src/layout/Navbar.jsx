...
function Navbar({ toggleSidebar }) {
  ...
  return (
    <div 
      className="flex items-center justify-between bg-white shadow-md px-6 fixed top-0 left-0 right-0 z-50"
    ...
    >
      ...
      <div className="flex items-center gap-34">
        <div className="flex items-center gap-1">
          ...
          <span className="text-blue-900 font-bold text-2xl">NexaAdmin</span>
        </div>
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="relative">
          ...
          {usernameOpen && (
            <div className="absolute right-0 mt-2 w-70 bg-white rounded-md shadow-lg py-2 px-2 divide-gray-300 divide-y">
